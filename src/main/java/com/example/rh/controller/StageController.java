    ...
    public class StageController {
        ...
        public ResponseEntity<ApplicationResponse> addEncadrantFeedback(
                @PathVariable Long applicationId,
                @RequestBody FeedbackRequest feedbackRequest) {

            ApplicationResponse updatedApplication = stageService.addEncadrantFeedback(
                    applicationId,
                    feedbackRequest.getNotes(),
                    feedbackRequest.getEncadrantComments()
            );
